...
const About: React.FC = () => {
  ...
  return (
    <div>
      <p>
        Hello! My name is Daniel and I'm a rising Senior at Rollins College in
            ...
            (styles, item) =>
              item && (
                <animated.img
                  src={rollinsIcon}
                  alt="rollins-logo"
                  className={astyles.rollinsLogo}
                  style={styles}
                />
              )
          )}
          <img src={rollins} alt="rollins" className={astyles.rollinsImg} />
        </div>
      </div>
      <p>
        <br />
        ...
        for bringing purposeful ideas to fruition. I enjoy building, designing,
        and engineering digital experiences.
        <br />
        <br />
        ...
        . I've also built user-friendly, inclusive, and powerful digital
        experiences at{" "}
        <AboutLink data={companiesData.supersharkz}>
          one of Malaysia's largest swim schools
        </AboutLink>
        . Last summer, I was an intern at one of the{" "}
        <AboutLink data={companiesData.zendesk}>
          top customer service software providers in the world
        </AboutLink>
        .
        <br />
        <br />
        Outside anything computer science related, I enjoy playing jazz,
        swimming, chess, and discovering new places to eat.
      </p>
    </div>
  );
};
